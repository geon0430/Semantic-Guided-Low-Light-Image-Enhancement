...
# Weight Parameters
parser.add_argument('--lowlight_images_path', type=str, default="low/")
# 정답지 위치 추가
parser.add_argument('--highlight_images_path', type=str, default="high/")
parser.add_argument('--snapshots_folder', type=str, default="weight/")
parser.add_argument('--load_pretrain', type=bool, default=False)
parser.add_argument('--pretrain_dir', type=str, default="./weight/NOX.pth")
