...
#         # Ensure the enhanced and target images have the same shape
#         if enhanced_image.shape != target_image.shape:
#             raise ValueError("Enhanced image and target image must have the same dimensions for RMSE calculation.")

#         # Calculate the Mean Squared Error (MSE) loss
#         mse_loss = F.mse_loss(enhanced_image, target_image, reduction='mean')
